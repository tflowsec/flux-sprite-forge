...
```text
1. base still          flux_generate.py / existing PNG on #FF00FF
2. video               flux_video.py i2v  (6s default, 5-20s optional)
...
- Missing `BFL_API_KEY` or FLUX 3 video unavailable
